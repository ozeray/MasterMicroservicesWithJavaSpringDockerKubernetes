...
public class LoansController {
	...
	@PostMapping("/myLoans")
	public List<Loans> getLoansDetails(@RequestHeader("ahmet-correlation-id") String correlationId, @RequestBody Customer customer) {
		log.info("CorrelationID in loans: {}", correlationId);
